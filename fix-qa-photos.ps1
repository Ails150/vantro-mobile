Write-Host "=== VANTRO QA PHOTO FIX ===" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "qa.tsx replaced" -ForegroundColor Green

# ─── COMMIT AND BUILD ──────────────────────────────────
cd C:\vantro-mobile
git add .
git commit -m "Fix: QA checklist photo upload - black screen on library, duplicate photo blocks, upload failures"
eas build --platform android --profile preview

Write-Host ""
Write-Host "Build submitted - wait for APK link" -ForegroundColor Cyan
