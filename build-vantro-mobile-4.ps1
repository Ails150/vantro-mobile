...
'@ | Set-Content "app/(installer)/_layout.tsx" -Encoding UTF8

# ─── app/(installer)/jobs.tsx ────────────────────────────────
@'
...
'@ | Set-Content "app/(installer)/jobs.tsx" -Encoding UTF8

Write-Host "Part 4 done - installer layout and jobs screen created" -ForegroundColor Green
